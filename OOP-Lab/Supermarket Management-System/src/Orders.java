...
public class Orders extends Function{
    ...
    protected String[] itemsPricePerQuantity;
    protected String[] itemsQuantity;
    protected double[] totalPrice;
    
    protected int newOrderID = -1;
    ...
    protected void createOrder(String date, String username, String itemsName, String itemsPricePerQuantity, String itemsQuantity, double totalPrice){
        this.newOrderID++;
    ...
    protected String[] getOrderinfo(String date){
    ...
    protected void editOrder(int orderID, String date, String username, String itemsName, String itemsPricePerQuantity, String itemsQuantity){
    ...
    protected void saveOrderInfo() throws Exception{
        File file = new File("../Orders.txt");

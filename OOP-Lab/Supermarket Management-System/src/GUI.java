...
public class GUI{
	...
	private int COLOR_GREENISH = 0x1BA466;
	private int COLOR_SKY_BLUE = 0x195ABE;
	private int FONT_HEADER1_SIZE = 30;
	private int FONT_HEADER2_SIZE = 20;
	private int FONT_DEFAULT_SIZE = 15;
	private int POSITION_X_LOGIN = (SCREEN_WIDTH/2)-185;
	private int POSITION_Y_LOGIN = (SCREEN_HEIGHT/2)-150;
	private int POSITION_X_USER = 200;
	private int POSITION_Y_USER = 100;
	private int POSITION_X_CONTENT = 200;
	private int POSITION_Y_CONTENT = 200;
	private int arraySize = 100;
	private int length;
	
	protected String FRAME_TITLE = "Supermarket Management System";
	protected String ROOT_PASSWORD = "admin1234";
	protected String FONT_DEFAULT = "proxima-nova";
	...
	// other objects
	public DateTimeFormatter dtf = DateTimeFormatter.ofPattern("yyyy-MM-dd_HH:mm:ss");

	// frame
	protected JFrame frame;

	// panel
	protected JPanel userLoginPanel;
	protected JPanel userSignupPanel;
	protected JPanel userPanel;
	protected JPanel userProfilePanel;
	protected JPanel userOrdersPanel;

	protected JPanel adminLoginPanel;
	
	protected JPanel adminPanel;
	protected JPanel adminControlPanel;
	protected JPanel adminViewOrdersPanel;

	// labels
	protected JLabel labelLogin;
	protected JLabel labelUsername;
	protected JLabel labelPassword;
	protected JLabel labelProfileHeader;
	protected JLabel labelUserMarketHeader;
	protected JLabel labelUserOrdersHeader;
	protected JLabel labelProfileUsername;
	protected JLabel labelProfileMobileNo;
	protected JLabel labelProfilePassword;
	protected JLabel labelUserSignup;
	protected JLabel labelSignupUsername;
	protected JLabel labelSignupMobileNumber;
	protected JLabel labelSignupPassword;
	protected JLabel labelUserMarketItemIDHeader;
	protected JLabel labelUserMarketItemNameHeader;
	protected JLabel labelUserMarketPricePerQuantityHeader;
	protected JLabel[] labelUserMarketItemID;
	protected JLabel[] labelUserMarketItemName;
	protected JLabel[] labelUserMarketPricePerQuantity;
	protected JLabel[] labelUserMarketPrice;
	protected JLabel labelUserMarketQuantityHeader;
	protected JLabel labelUserMarketPriceHeader;
	protected JLabel labelUserMarketTotalPriceHeader;
	protected JLabel labelUserMarketTotalPrice;
	protected JLabel labelUserOrderIDHeader;
	protected JLabel labelUserOrderDateHeader;
	protected JLabel labelUserOrderTotalPriceHeader;
	protected JLabel[] labelUserOrderID;
	protected JLabel[] labelUserOrderDate;
	protected JLabel[] labelUserOrderTotalPrice;

	protected JLabel labelAdminLogin;
	protected JLabel labelAdminPassword;
	protected JLabel labelAdminMarketHeader;
	protected JLabel labelAdminControlHeader;
	protected JLabel labelAdminViewOrdersHeader;
	protected JLabel labelAdminAddItemsHeader;
	protected JLabel labelAdminControlUserIDHeader;
	protected JLabel labelAdminControlUsernameHeader;
	protected JLabel labelAdminControlMobileNoHeader;
	protected JLabel[] labelAdminControlUserID;
	protected JLabel[] labelAdminControlUsername;
	protected JLabel[] labelAdminControlMobileNo;
	protected JLabel labelAdminMarketItemIDHeader;
	protected JLabel labelAdminMarketItemNameHeader;
	protected JLabel labelAdminMarketPriceHeader;
	protected JLabel[] labelAdminMarketItemID;
	protected JLabel[] labelAdminMarketItemName;
	protected JLabel[] labelAdminMarketPrice;
	protected JLabel labelAdminMarketAddItemName;
	protected JLabel labelAdminMarketAddPrice;
	protected JLabel labelAdminOrderIDHeader;
	protected JLabel labelAdminOrderDateHeader;
	protected JLabel labelAdminOrderUsernameHeader;
	protected JLabel labelAdminOrderTotalPriceHeader;
	protected JLabel[] labelAdminOrderID;
	protected JLabel[] labelAdminOrderDate;
	protected JLabel[] labelAdminOrderUsername;
	protected JLabel[] labelAdminOrderTotalPrice;


	// checkbox
	protected JCheckBox[] checkboxUserOrders;

	protected JCheckBox[] checkboxAdminControl;
	protected JCheckBox[] checkboxAdminMarket;
	protected JCheckBox[] checkboxAdminOrders;
	
	// textfields
	protected JTextField textfieldUsername;
	protected JTextField textfieldEditUsername;
	protected JTextField textfieldEditMobileNo;
	protected JTextField textfieldSignupUsername;
	protected JTextField textfieldSignupMobileNumber;
	protected JTextField[] textfieldUserMarketItemQuantity;

	protected JTextField textfieldAdminMarketAddItemName;
	protected JTextField textfieldAdminMarketAddPrice;

	// passwordfileds
	protected JPasswordField passwordFieldUser;
	protected JPasswordField passfieldEditPassword;
	protected JPasswordField passwordFieldSignupUser;
	protected JPasswordField passwordFieldAdmin;
	
	// buttons
	protected JButton btnUserProfile;
	protected JButton btnUserLoginAttempt;
	protected JButton btnUserSignupPanel;
	protected JButton btnUserMarket;
	protected JButton btnUserOrders;
	protected JButton btnUserLogout;
	protected JButton btnUserDeleteAccount;
	protected JButton btnUserSaveChanges;
	protected JButton btnUserLoginPanel;
	protected JButton btnUserSignupAttempt;
	protected JButton btnUserMarketPlaceOrder;
	protected JButton btnUserMarketCalculate;
	protected JButton btnUserOrderView;
	
	protected JButton btnAdmin;
	protected JButton btnAdminLoginAtttempt;
	protected JButton btnAdminUser;
	protected JButton btnAdminLogout;
	protected JButton btnAdminControl;
	protected JButton btnAdminControlDelete;
	protected JButton btnAdminMarket;
	protected JButton btnAdminViewOrders;
	protected JButton btnAdminMarketAdditem;
	protected JButton btnAdminMarketDelete;
	protected JButton btnAdminOrderView;
	...
	GUI() throws Exception{
		...
		userLoginPanel.setBackground(Color.GRAY.brighter());
				...
				if(users.illegalUserTextInput(textfieldUsername.getText()) || users.illegalUserTextInput(String.valueOf(passwordFieldUser.getPassword()))){
					...
					btnUserMarket.addActionListener(new ActionListener(){
						...
						public void actionPerformed(ActionEvent arg0) {
							...
							userPanel.add(btnUserLogout);
							userPanel.add(labelUserMarketHeader);
							//userPanel.setBackground(Color.gray.brighter());
		...
		btnUserSignupPanel.addActionListener(new ActionListener(){
			...
			public void actionPerformed(ActionEvent arg0) {
				...
				userSignupPanel.setBackground(Color.GRAY.brighter());

...
public class Users extends Function{
    ...
    protected void createUser(String username, String mobileNo, String password){
        this.newUserID++;
    ...
    protected void editUserinfo(int userID, String username, String mobileNo, String password){
        this.username[userID] = username;
        this.mobileNo[userID] = mobileNo;
        this.password[userID] = password;
    }

    protected void saveUserinfo() throws Exception{
        File file = new File("../Users.txt");
